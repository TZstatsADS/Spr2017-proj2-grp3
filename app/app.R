...
body <- dashboardBody(
  ...
  fluidRow(
    ...
    box(
      title="Map", width = 8, height = 550, status="primary", solidHeader = TRUE,
      leafletOutput("map2", height = 500)
    ),
    box(
      title = "Legend", width = 4, height = 550, status="warning", solidHeader = TRUE,
      conditionalPanel("input.cate=='Mortality'",sliderInput("year", label = h3("Year"),
                  min = 2010, max = 2014, value = 2012, 
                  step = 1, ticks = FALSE, sep="")),
      conditionalPanel("input.cate=='Prevalence'",sliderInput("year", label = h3("Year"),
                                                             min = 2012, max = 2014, value = 2012, 
                                                             step = 1, ticks = FALSE, sep="")),
      conditionalPanel("input.cate=='Prevalence' & input.year==2012",selectInput("gender", label = h3("Gender"), 
                  choices = list("Overall"= "Overall"), 
                  selected = 1)),
      conditionalPanel("input.cate=='Prevalence' & input.year==2013",selectInput("gender", label = h3("Gender"), 
                                                                                   choices = list("Overall"= "Overall", "Male"="Male", "Female"= "Female"), 
                                                                                   selected = 1)),
      conditionalPanel("input.cate=='Prevalence' & input.year==2014",selectInput("gender", label = h3("Gender"), 
                                                                                   choices = list("Overall"= "Overall", "Male"="Male", "Female"= "Female"), 
                                                                                   selected = 1)),
      conditionalPanel("input.cate=='Mortality'",selectInput("gender", label = h3("Gender"), 
                                                                                   choices = list("Overall"= "Overall", "Male"="Male", "Female"= "Female"), 
                                                                                   selected = 1)),
